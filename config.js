...
global.github=process.env.GITHUB|| "https://github.com/Raone01";
...
global.devs = "919634945456" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "919634945456";
...
module.exports = {
  ...
  LANG: ( process.env.THEME ||  "▪️▫️▪️ѕιℓєηт  χαямσηу🦚"  ).toUpperCase(),
